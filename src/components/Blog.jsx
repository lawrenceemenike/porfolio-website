  ...
  return (
    <section id="blog" className="section-padding border-t border-white/10">
      <div className="container-max">
        <h2 className="text-3xl font-serif font-bold mb-12">Selected Essays</h2>
        ...
        <div className="flex flex-col">
          {portfolioData.blog.map((post, index) => (
            ...
            >
              <h3 className="text-lg font-serif font-medium text-gray-300 group-hover:text-white transition-colors">
                {post.title}
              </h3>
              <span className="font-mono uppercase tracking-widest text-xs text-gray-500 whitespace-nowrap">
                {post.date}
              </span>
            </a>
          ))}
